...
%token CMD_SET_LOGIC CMD_SET_INFO CMD_SET_OPTION CMD_DECLARE_SORT CMD_DEFINE_SORT CMD_DECLARE_FUN CMD_DEFINE_FUN
...
command
  ...
  | PAR_OPEN CMD_SET_OPTION solver_option PAR_CLOSE
	                                    { CSetOption $3 }
  | PAR_OPEN CMD_DEFINE_SORT symbol PAR_OPEN symbol_list PAR_CLOSE sort PAR_CLOSE
                                      { CDefineSort ($3, $5, $7)}
