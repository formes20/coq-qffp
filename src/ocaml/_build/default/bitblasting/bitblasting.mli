...
val bexps_of_file : file -> vm * tm * SSATE.env * int * Fq2bvq.fp_bexp list * QFBV.bexp list
...
val check_sat_file : file -> smtlib_assignments sat_result list * vm * tm * SSATE.env * Fq2bvq.fp_bexp list * QFBV.bexp list
