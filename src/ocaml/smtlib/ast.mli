...
val fn_fp_isZero : string
val fn_fp_isNormal : string
val fn_fp_isSubNormal : string
val fn_fp_isInfinite : string
val fn_fp_isNaN : string
val fn_fp_isPositive : string
val fn_fp_isNegative : string

val fn_fp_eq : string
val fn_fp_lt : string
val fn_fp_gt : string
val fn_fp_leq : string
val fn_fp_geq : string

val fn_fp_abs : string
val fn_fp_neg : string

val fn_fp_max : string
val fn_fp_min : string

val fn_fp_mul : string
val fn_fp_add : string
val fn_fp_sub : string
val fn_fp_fma : string
val fn_fp_div : string
val fn_fp_sqrt : string
val fn_fp_rem : string
val fn_fp_roundToIntegral : string

val fn_to_fp : string
val fn_to_fp_unsigned : string
val fn_fp_to_ubv : string
val fn_fp_to_sbv : string
...
val ttyp_of_sort : sort -> sm -> ttyp
val ttyp_of_spec_constant : spec_constant -> ttyp
val ttyp_of_identifier : tm -> identifier -> ttyp
val ttyp_of_qual_identifier : tm -> sm -> qual_identifier -> ttyp
val ttyp_of_term : tm -> fm -> sm -> term -> ttyp
val is_bool_term : tm -> fm -> sm -> term -> bool
